...
public class JavaMailUtil {
	// 发件人的邮箱-修改为自己的
	public static String emailAccount = "1809783487@qq.com";
	// 发件人邮箱授权码-修改为自己的
	public static String emailPassword = "necqvkiisrqddjgg";
	// 发件人邮箱服务地址-修改为自己的
	...
	public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html) throws MessagingException, IOException {
		...
		// 2、From：发件人
		message.setFrom(new InternetAddress(sendMail, "白熊云", "UTF-8"));
		// 3、To:收件人（可以增加多个收件人：抄送或者密送）
		message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "FUCXXXX", "UTF-8"));
		// 4、Subject:邮件主题
