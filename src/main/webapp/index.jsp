...
<body id="login">
	<div class="container">
		<form class="form-signin" name="loginForm" method="post" action=""
			...
			<h2 class="form-signin-heading">白熊云登录</h2>
			<label for="inputAccount" class="sr-only">账号</label> <input
				type="text" name="userName" id="userName" class="form-control"
				placeholder="邮箱地址"> <label for="inputPassword"
			...
			<button class="btn btn-link" data-toggle="modal"
				data-target="#updateModel">忘记密码？</button>
					...
					<form class="form-horizontal" name="RegistForm" method="post"
						...
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-medium focused" id="signupUsername"
										name="signupUsername" type="text" placeholder="自定义名称"
										required>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="password" placeholder="密码至少6位"
										class="input-medium focused" id="signupPwd" name="signupPwd"
										required>
								</div>
							</div>
							<div class="control-group" id="checkpwd">
								<label class="control-label" for="focusedInput">确认密码</label>
								<div class="controls">
									<input class="input-medium focused" id="signupRepwd"
										name="signupRepwd" type="password" placeholder="再次输入密码"
										onchange="checkField(this.value)"> <span
										class="help-inline" id="notice"></span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="email" placeholder="qq邮箱地址" class="input-medium focused"
								id="signupAccount" name="signupAccount" required/>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="code" id="code"
										class="input-medium focused" required>
...
<div class="modal-dialog">
	...
	<script>
		function checkField(value) {
			var div = document.getElementById('checkpwd');
			var span = document.getElementById('notice');
			if(document.getElementById("signupPwd").value  != value){
				div.className = 'control-group error'; 
				span.innerHTML ='两次输入密码必须相同！'
			}else{
